    ...
    <>
      <div className="about flex flex-col py-5 mx-4 md:mx-30 my-5 overflow-x-hidden" id='about'>
          ...
          <div className="education-card flex flex-wrap md:flex-nowrap gap-3 justify-center">
            {allApiData?.education.map((degree) => {
              return (
                <div
                  key={degree.id}
                  className="card flex flex-col w-100 gap-3 p-3 my-3 border border-blue-400/25 shadow-md/50 shadow-blue-400 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 rounded bg-gradient-to-t from-blue-500/10"
        ...
        <div className='flex flex-col md:mx-10 mb-10'>
          <div className="title flex w-fit text-2xl font-bold mb-5 border-b-3 border-b-blue-400">
            Skills
          </div>
